...
strAll_Retina_Output	= strOutputFldr & "\" & "~All_Combined.xml"
...
MsgBox ("THE FILES HAVE NOW BEEN MERGED")
MsgBox ("THE NEW MERGED FILE, WILL NOW BE ZIPPED UP FOR UPLOADING INTO VMS")

'Setting up what will become the final product
...
'*********************************************************************
'****Below the process will create and fill a new zip file for you****
'*********************************************************************

MySource = strCurAppPath & "~All_Combined.xml"
MyTarget = strCurAppPath & "All_Combined.zip"
...
'Create Zip File to house the new combined xml
'This will make it easier to upload into VMS
...
'Placing the XML into the zip file that was created

set winShell = createObject("shell.application")
winShell.namespace(MyTarget).CopyHere MySource

wScript.Sleep(40000) 
MsgBox("Please ensure the process has completed zipping your file")
MsgBox("You should now have a nice zip file for uploading and a Combined XML")
